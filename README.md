...
If you need to decommission workload clusters `aks0` and `aks1` (with `aks0` used for CNPG/PostgreSQL and `aks1` for the demo app), use this runbook: [Clean Uninstall: aks0 + aks1](./docs/uninstall-aks0-aks1.md).
